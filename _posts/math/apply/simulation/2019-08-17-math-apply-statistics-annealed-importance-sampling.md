---
layout: post
title: "Statistics: Annealed importance Sampling"
...
def f_j(x, beta):
    ...
    return f_0(x)**beta * f_0(x)**(1-beta)
...
#### Reference
[Annealed Importance Sampling](https://wiseodd.github.io/techblog/2017/12/23/annealed-importance-sampling/)
